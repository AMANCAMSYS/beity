...
As a home owner or admin, I want to invite new members to my home by email or phone number, so that they can join and collaborate on household management.
...
3. **Given** I am a home owner, **When** I try to remove myself, **Then** I see an error indicating owners cannot leave (must transfer ownership first)

---

### Edge Cases

- What happens when an invitation expires (after 7 days)?
...
- What happens when an owner tries to leave the home without transferring ownership?
...
- **FR-007**: System MUST enforce role-based permissions for home actions
...
- **FR-012**: System MUST send notifications for new invitations
