...
class AppTourTargetRegistry {
  ...
  static final firstShoppingJourneyKey = GlobalKey(
    debugLabel: 'tour_first_shopping_journey',
  );
  static final quickAddKey = GlobalKey(debugLabel: 'tour_quick_add');
  static final shoppingModeActionKey = GlobalKey(
    debugLabel: 'tour_shopping_mode_action',
  );
  static final aiSuggestionsKey = GlobalKey(debugLabel: 'tour_ai_suggestions');

  static final listsTabKey = GlobalKey(debugLabel: 'tour_lists_tab');
  static final shoppingTabKey = GlobalKey(debugLabel: 'tour_shopping_tab');
  static final activityTabKey = GlobalKey(debugLabel: 'tour_activity_tab');
  ...
  static final expensesSummaryKey = GlobalKey(
    debugLabel: 'tour_expenses_summary',
  );
  static final expensesBalancesKey = GlobalKey(
    debugLabel: 'tour_expenses_balances',
  );
  static final expensesFilterKey = GlobalKey(
    debugLabel: 'tour_expenses_filter',
  );
  static final inventoryAddKey = GlobalKey(debugLabel: 'tour_inventory_add');
  static final inventoryFilterKey = GlobalKey(
    debugLabel: 'tour_inventory_filter',
  );
  ...
  static final categoriesFilterKey = GlobalKey(
    debugLabel: 'tour_categories_filter',
  );
