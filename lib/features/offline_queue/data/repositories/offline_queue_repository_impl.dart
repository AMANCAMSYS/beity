...
class OfflineQueueRepositoryImpl implements OfflineQueueRepository {
  ...
  OfflineQueueRepositoryImpl(this.dataSource);
  ...
  Future<List<QueueEntry>> getEntriesByUserScope(String userId) {
    return dataSource.getEntriesByUserScope(userId);
  }

  @override
  Future<List<QueueEntry>> getEntriesByGlobalScope() {
    return dataSource.getEntriesByGlobalScope();
  }
  ...
  Future<int> getPendingCountForUser(String userId) {
    return dataSource.getPendingCountForUser(userId);
  }
  ...
  Future<void> resetProcessingToPendingForUserScope(String userId) {
    return dataSource.resetProcessingToPendingForUserScope(userId);
  }
}
