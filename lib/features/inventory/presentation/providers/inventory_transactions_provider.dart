...
final inventoryTransactionsProvider = StreamProvider.autoDispose
    .family<List<InventoryTransactionModel>, String>((ref, itemId) {
      final repository = ref.watch(inventoryRepositoryProvider);
      return repository.watchTransactions(inventoryItemId: itemId);
    });

final inventoryTransactionsListProvider =
