...
class ActivityFilterWidget extends ConsumerWidget {
              ...
              data: (actors) => DropdownButtonFormField<String>(
                ...
                items: [
                  const DropdownMenuItem<String>(
                    value: null,
                    child: Text('جميع الأعضاء'),
                  ),
                  ...actors.map((actor) => DropdownMenuItem<String>(
                        value: actor.userId,
                        child: Text(actor.displayName ?? 'مستخدم'),
                      )),
                ],
                onChanged: (value) {
  ...
  Widget _buildFilterChip(
    ...
    final isSelected = selectedActions != null &&
