...
class ShoppingModeListScreen extends ConsumerStatefulWidget {
  ...
  const ShoppingModeListScreen({
    super.key,
    required this.homeId,
  });

  @override
  ConsumerState<ShoppingModeListScreen> createState() => _ShoppingModeListScreenState();
}

class _ShoppingModeListScreenState extends ConsumerState<ShoppingModeListScreen> {
  @override
    ...
    return Scaffold(
      ...
      body: activeLists.isEmpty
          ? BeityEmptyState(
              ...
              message: context.translate('no_active_lists_desc_shopping_mode'),
          ...
          : ListView(
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        context.translate('shopping_mode_subtitle_instructions'),
                ...
                ...activeLists.map((list) => _buildShoppingListCard(context, ref, list)),
              ],
            ),
    );
  }
                ...
                return Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          context.translate('shopping_progress_label', arguments: {
                    ...
                    SizedBox(
                      ...
                      child: FilledButton.icon(
                        onPressed: () => ActionDebouncer.execute(() async {
                          context.push(
                            '/shopping-list/${list.id}/shopping-mode',
