...
class AppColors {
  ...
  // Domain Colors
  static const Color shoppingActive = Color(0xFFE8F5E9);
  static const Color shoppingActiveDark = Color(0xFF1B3A1B);
  static const Color purchasedMuted = Color(0xFFF5F5F5);
  static const Color purchasedMutedDark = Color(0xFF2A2A2A);
  ...
  static const Color backgroundDark = Color(0xFF161A16);
