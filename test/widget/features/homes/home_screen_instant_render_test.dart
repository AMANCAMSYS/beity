...
import 'package:beity/features/home/data/datasources/home_dashboard_snapshot_datasource.dart';
import 'package:beity/features/shopping_lists/presentation/providers/shopping_lists_provider.dart';
import 'package:beity/features/activity_logs/presentation/providers/activity_logs_provider.dart';
import 'package:beity/features/activity_logs/data/models/activity_log_model.dart';
...
void main() {
  ...
  testWidgets('HomeScreen should render cached snapshot data instantly when live providers are loading', (tester) async {
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          ...
          connectivityStatusProvider.overrideWith((ref) => Stream.value(DeviceSyncStatus.online)),
          ...
          shoppingListsProvider('home-123').overrideWith((ref) => const Stream.empty()),
          recentHomeActivityProvider('home-123').overrideWith((ref) => StreamController<List<ActivityLogModel>>().stream),
          
          // Provide our synchronous cached snapshot
          cachedHomeDashboardSnapshotProvider('home-123').overrideWithValue(testSnapshot),
