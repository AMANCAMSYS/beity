...
void main() {
  group('Privacy Leak Prevention', () {
    test(
      'AiSuggestionRequestModel does NOT include PII (emails, tokens, IDs)',
      () {
        ...
        expect(
          extraKeys,
          isEmpty,
          reason: 'Request payload contains unauthorized fields: $extraKeys',
        );
        ...
        for (final key in piiKeys) {
          expect(
            ...
            isFalse,
            reason: 'Request payload leaked PII: $key',
          );
        }
      },
    );
