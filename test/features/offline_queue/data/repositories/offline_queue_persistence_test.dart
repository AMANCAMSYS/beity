...
class FakeOfflineQueue {
  ...
  Future<void> enqueue(String userId, String homeId, String action, Map<String, dynamic> data) async {
    _storage.add({
      'user_id': userId,
      'home_id': homeId,
      'action': action,
  ...
  Future<List<Map<String, dynamic>>> getEntries(String userId, String homeId) async {
    return _storage.where((e) => e['user_id'] == userId && e['home_id'] == homeId).toList();
  }
