...
import 'package:sawa/features/ai_suggestions/domain/entities/ai_mode.dart';
import 'package:sawa/features/ai_suggestions/presentation/widgets/ai_mode_selector.dart';
import 'package:sawa/features/inventory/presentation/widgets/quantity_adjuster_widget.dart';
...
void main() {
  ...
  group('Refinements - Inventory Low Stock logic', () {
    ...
    test(
      'isLowStock returns false when quantity > minQuantity or minQuantity is null',
      () {
  ...
  group('Refinements - AI Mode Selector Widget', () {
    testWidgets('AiModeSelector renders portals and handles taps', (
      WidgetTester tester,
    ) async {
      AiMode? changedMode;
  ...
  group('Refinements - Feedback ScreenRoute Attachment', () {
    testWidgets('FeedbackBottomSheet registers and renders screenRoute name', (
      WidgetTester tester,
    ) async {
      ...
      expect(
        find.text(
          localizations.translate(
            ...
            arguments: {'route': '/inventory-details'},
          ),
        ),
        findsOneWidget,
      );
  ...
  group('Refinements - Device Locale detection', () {
    ...
    test(
      'getLocale returns saved locale if present in SharedPreferences',
      () async {
    ...
    test(
      'getLocale returns device locale if supported and no saved locale',
      () async {
        final repository = AppSettingsRepository();
        final locale = await repository.getLocale();
